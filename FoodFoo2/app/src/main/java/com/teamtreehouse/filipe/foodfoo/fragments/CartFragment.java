...
import com.teamtreehouse.filipe.foodfoo.ui.CartListViewFragment;
...
public class CartFragment extends CartListViewFragment{

    @Override
    public ArrayList<Dish> getContents() {
        FoodFooDataSource dataSource = new FoodFooDataSource(getContext());

        ArrayList<Dish> dishes = dataSource.readDishes("cart");
